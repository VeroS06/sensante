...
print("Figure sauvegardee dans notebooks/confusion_matrix.png")
import joblib
import os
...
# Un nouveau patient arrive au centre de sante
nouveau_patient = {
    'age': 28,
    'sexe': 'F',
    'temperature': 39.5,
...
patients = [
    {'age': 19, 'sexe': 'F', 'temperature': 36.9, 'tension_sys': 120,
     'toux': False, 'fatigue': False, 'maux_tete': False, 'region': 'Dakar'},
    {'age': 35, 'sexe': 'F', 'temperature': 40.1, 'tension_sys': 110,
     'toux': True, 'fatigue': True, 'maux_tete': True, 'region': 'Dakar'},
    {'age': 68, 'sexe': 'M', 'temperature': 38.2, 'tension_sys': 140,
